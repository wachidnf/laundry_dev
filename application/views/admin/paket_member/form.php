...
<div class="modal fade" id="tambah" role="dialog" tabindex="-1"  aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!--Modal body-->
            <form action="<?=site_url('Admin/PaketMember/create')?>" class="form-horizontal" method="post" enctype="multipart/form-data">
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="demo-is-inputnormal" class="col-sm-3 control-label"><b>Kuota (kg)</b></label>
                    <div class="col-sm-8">
                        <input type="number" name="kuota" placeholder="Masukkan Jumlah Kuota" class="form-control">
                    </div>
                </div>
                <div class="form-group">
...
<div class="modal fade" id="Edit<?=$p->id?>" role="dialog" tabindex="-1"  aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!--Modal body-->
            <form action="<?=site_url('Admin/PaketMember/edit/').$p->id?>" class="form-horizontal" method="post" enctype="multipart/form-data">
            <div class="modal-body">
                <div class="form-group">
                    <label for="demo-is-inputnormal" class="col-sm-3 control-label"><b>Nama Paket</b></label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label for="demo-is-inputnormal" class="col-sm-3 control-label"><b>Kuota (kg)</b></label>
                    <div class="col-sm-8">
                        <input type="number" name="kuota" placeholder="Masukkan Jumlah Kuota" value="<?=$p->kuota?>" class="form-control">
                    </div>
                </div>
                <div class="form-group">
                    <label for="demo-is-inputnormal" class="col-sm-3 control-label"><b>Harga</b></label>
