    ...
    <div id="navbar-container" class="boxed">
        ...
        <div class="navbar-header">
            <a href="index.html" class="navbar-brand">
                <img src="<?= base_url('assets/images/logo.png') ?>" alt="Nifty Logo" class="brand-icon" style="padding-top: 15px; padding-bottom: 15px; padding-left: 15px; padding-right: 15px;">
                <div class="brand-title">
                <center><span class="brand-text">Admin</span></center>
                </div>
            </a>
        </div>
        <!--End brand logo & name-->
            ...
            <ul class="nav navbar-top-links">
                ...
                <li id="dropdown-user" class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right panel-default">
                        <ul class="head-list">
                            <li>
                                <a href="<?=site_url('Admin/Profile')?>"><i class="demo-pli-male icon-lg icon-fw"></i> Profile</a>
                            </li>
                            <li>
                                <a href="<?=site_url('Home/logout')?>"><i class="demo-pli-unlock icon-lg icon-fw"></i> Logout</a>
                            </li>
                        </ul>
                    </div>
                </li>
